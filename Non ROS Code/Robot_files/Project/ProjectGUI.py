# Project GUI v1.1 - Fixed UI bugs related to text input.
import cv2
import threading
...
class AIAssistantApp:
    ...
    def setup_ui(self):
        self.root.title("TIST AI Assistant - Project Version")
        ...
        # --- BUG FIX: Switched to grid layout for stability ---
    ...
    def toggle_text_input(self):
        # --- BUG FIX: Use grid_remove and grid for stable layout ---
    ...
    def on_submit_text(self):
        ...
        if user_input:
            # --- BUG FIX: Immediately update the label on text submit ---
