...
class PersonDetectionNode(Node):
    ...
    def analyze_frame(self):
        ...
        threading.Thread(target=self.run_detection, args=(frame_to_analyze,), daemon=True).start()
    ...
    def run_detection(self, frame):
        ...
        try:
            ...
            self.get_logger().error(f"An error occurred during face detection: {e}", throttle_duration_sec=5)
